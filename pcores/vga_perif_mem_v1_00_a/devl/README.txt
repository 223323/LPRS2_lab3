...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\materija\ra170-2013\lab3
  logical library name                       : vga_perif_mem_v1_00_a
  top name                                   : vga_perif_mem
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/vga_perif_mem_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/vga_perif_mem_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	C:\materija\ra170-2013\lab3\C:\Xilinx\14.6\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf
