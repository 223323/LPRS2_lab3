...
#
#  File     lab3_setup.tcl (Mon Apr  4 20:32:15 2016)
#
...
#  with the '-tclbatch lab3_setup.tcl' option.
...
proc PrintHelpInformation {} {
  ...
  puts "**********************************************************************"
  puts "***"
  puts "***   Simulation Setup Macros (lab3_setup.tcl)"
  puts "***"
  ...
  puts "***           viewer (edit signal lists in lab3_wave.tcl)"
  puts "***"
